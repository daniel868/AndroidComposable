package com.example.herodetail
...
import com.example.hero_domain.maxAttackDamage
import com.example.hero_domain.minAttackDmg
import com.example.herodetail.ui.HeroDetailState
            ...
            Row(
                ...
                Column(
                    ...
                    Row( // Attack damage
                        ...
                        val atkMax = remember { hero.maxAttackDamage() }
                        Text(
                            modifier = Modifier
                                .padding(bottom = 8.dp),
                            text = "${atkMin} - ${atkMax}",
